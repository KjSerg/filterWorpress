...
$count_publish_posts = $taxonomy->count;
...
//$min_price = get_min_price_with_projects();
//$max_price = get_max_price_with_projects();
//$steps = steps_for_range();
?>
    ...
    <section class="section-catalog pad_bot_section" style="background:#f3f6fa; ">
        <ul class="breadcrumbs">
            ...
            <li>Проекты домов <?php echo $taxonomy->name; ?></li>
        </ul>
        <div class="title-section left">
            <h1 class="title-section__text">
                Проекты домов <?php echo $taxonomy->name; ?>
            </h1>
        </div>
                ...
                <div class="catalog-filter__group">
                            ...
                            <div class="checked-group">
                                <?php foreach ($terms_house_type as $item): ?>
                                    <label class="checked-item">
                                        <input type="checkbox"
                                               <?php if($taxonomy->term_id == $item->term_id): ?>
                                                   checked
                                               <?php endif; ?>
                    ...
                    <div class="catalog-filter__item">
                        ...
                        <div class="range-group">
                            <input type="text" class="range" data-min="22500"  data-max="2222000" data-values="22500, 54750, 651000, 751250, 861500, 971750, 2222000">
                        </div>
                    </div>
                </div>
            </form>
